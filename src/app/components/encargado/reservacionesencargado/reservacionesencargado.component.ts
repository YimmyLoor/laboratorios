...
@Component({
  selector: 'app-reservacionesencargado',
  templateUrl: './reservacionesencargado.component.html',
  styleUrls: ['./reservacionesencargado.component.css']
})
export class ReservacionesencargadoComponent implements OnInit {
